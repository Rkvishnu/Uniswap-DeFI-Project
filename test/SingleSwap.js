...
describe("SingleSwapToken", () => {
  ...
  it("swapExactOutputSingle", async () => {
    const wethAmountInMax = 10n ** 18n;  // input amount  we deposit in
    // 1 ether ==100DAI
    const daiAmountOut = 100n * 10n ** 18n;  // output amount we want
    ...
    console.log("Dai balance of account 0 ", await dai.balanceOf(accounts[0].address));
    console.log("Dai balance of account 1", await dai.balanceOf(accounts[1].address));
  });
});