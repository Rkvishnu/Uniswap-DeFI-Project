...
//poolFee= 0.01% that we are going to charge for swapping tokens
...
// every liquidity will have a unique identity so we sued erc721 package from openzeppelin
struct Deposit{
    address owner;
    uint128 liquidity;
    address token0;
...
mapping(uint=>Deposit) public deposits;
 ...
 //store tokenId used in this example
 uint public tokenId;


  //1. Implementing `onERC721Received` so this contract can receive custody of erc721 tokens
...
// functioon for depositing money in token0 and token1 and creating liquidity
...
{
    //for thhis example we will provide equal amounts (50:50) of liquidity in both assets
    //  Providing liquidity in both assets means liquidity will be  earning fees and is considered in-range
      ...
      memory params= INonfungiblePositionManager.MintParams({
        ...
        fee:poolFee,
                ...
                // By using TickMath.MIN_TICK and TickMath.MAX_TICK from TickMath.sol uniswap library
    ...
    //3.  function to collect  all the fees
    ...
    //4.function to increase liquidity 
    // if you want ot provide more liquidity
    //
    ...
    //5. function to getLiquidity  
    // function to check how much liquidity w ehave provided till now
